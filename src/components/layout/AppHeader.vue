...
<template>
  <header
    class="flex h-12 flex-shrink-0 items-stretch border-b border-gray-200"
  ...
  >
    ...
    <div class="flex min-w-0 flex-1 items-stretch overflow-hidden">
      ...
      >
        <li
          ...
          :key="tab.id"
          class="group flex flex-shrink-0 cursor-pointer items-center gap-1 border-b-2 px-3 text-xs transition-colors"
          :class="
        ...
        >
          ...
          <button
            v-if="tab.closable"
            class="ml-0.5 rounded p-0.5 text-gray-400 opacity-0 hover:bg-gray-200 hover:text-gray-700 group-hover:opacity-100"
    ...
    <div class="flex items-center gap-3 border-l border-gray-200 px-3">
      <span class="text-xs tabular-nums text-gray-500">{{ sessionTime }}</span>
